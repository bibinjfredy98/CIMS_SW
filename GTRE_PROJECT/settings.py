...
# ALLOWED_HOSTS = ['192.168.0.109']      ### this is for tp link

# ALLOWED_HOSTS = ['192.168.99.96']
...
################  the bottom is for the docker 

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.mysql",
        "NAME": os.getenv("MYSQL_DATABASE", "ivasystems"),  # Use environment variables
        "USER": os.getenv("MYSQL_USER", "root"),
        "PASSWORD": os.getenv("MYSQL_PASSWORD", "bibinjfredy1998"),
        "HOST": os.getenv("MYSQL_HOST", "mysql"),  # Docker Compose service name
        "PORT": os.getenv("MYSQL_PORT", "3306"),  # Default MySQL port inside Docker
    }
}
